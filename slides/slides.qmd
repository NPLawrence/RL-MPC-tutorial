...
:::
::: {.column width="20%"}
![Cheat sheet!](figs/qr-cheatsheet.png)
:::
::::
...
![](figs/fixedpoint.png){fig-align="center"}
...
If we have a policy $\pi$ and some oracle that tells us $Q^\pi$, take 
\begin{align}
...
Then $\pi^{+}$ is at least as good as $\pi$! That is, $Q^{+} = B(Q^\pi) \geq Q^\pi$.
...
There are many ways to proceed: Policy iteration, value iteration, and we haven't even mentioned policy evaluation. 
We're focusing on high-level ideas and avoiding introducing jargon, so see @sutton2018ReinforcementLearning for a full treatment.
...
## Todo: Try to formulate a reward function
...
![](videos/gamma_90/acrobot-sac__default__1__episode-1950.mp4)

![](videos/gamma_90/acrobot-sac__l2__1__episode-1950.mp4)

![](videos/gamma_90/acrobot-sac__height__3__episode-1950.mp4)

![](videos/gamma_90/acrobot-sac__linf__1__episode-1950.mp4)
...
![](videos/gamma_99/acrobot-sac__default__0__episode-1950.mp4)

![](videos/gamma_99/acrobot-sac__l2__2__episode-1950.mp4)

![](videos/gamma_99/acrobot-sac__height__1__episode-1950.mp4)

![](videos/gamma_99/acrobot-sac__linf__2__episode-1950.mp4)
:::
...
## An analytic solution: What if we know something about the environment? {.center}
...
![@bertsekas2022lessons](figs/alphazerobertsekas.jpg)
...
- [SAC (Acrobot)](https://wandb.ai/nplawrence/acrobot-upperbound?nw=nwusernplawrence)
- [DQN (Cartpole & Acrobot)](https://wandb.ai/nplawrence/acrobot-cartpole-dqn-upperbound/overview)
