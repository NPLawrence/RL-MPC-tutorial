...
institute: "UBC mathematics"
date: last-modified
abstract: "Online version of the presentation given at [Upper Bound 2024](https://www.upperbound.ai/speakers/SPEWNJXVTAX). Code and slides available [here](https://github.com/NPLawrence/RL-MPC-tutorial)."
format: 
    html:
...
::: r-stack
![](figs/4_intro_rlmpc.png){fig-align="center"}
:::
...
![](figs/sysid.png){height=125 fig-align="center"}


## 


![](figs/2_mapofcontrol.png){fig-align="center"}
...
:::
::: {.column width="20%"}
![Cheat sheet! ([github](https://github.com/NPLawrence/RL-MPC-tutorial))](figs/qr-github.png)
:::
::::
...
![](videos/pendulum.gif){height=350 fig-align="center"}
...
![](figs/RL_illustration.png){height=250 fig-align="center"}
...
States governed by $$s_{t+1} \sim p \left( s_{t+1} \middle| s_t, a_t \right)$$ 

Agent chooses actions from a **policy** $$a_t \sim \pi\left( a_t \middle| s_t \right)$$ 

Rewards assigned by a function $$r_t = r(s_t, a_t)$$
...
![](videos/gritty.gif){ height=190 fig-align="center"}
:::

::: {.fragment .fade-in-then-out fragment-index=2}
![](figs/Honey_UDC.png){ height=210 fig-align="center"}
:::

::: {.fragment .fade-in-then-out fragment-index=3}
![](figs/nn.png){height=230 fig-align="center"}
:::
:::
...
![](figs/Honey_UDC.png){height=150 fig-align="center"}
...
<p><span class="emoji">&#9989;</span>   Pick $\gamma \in [0,1]$ and consider</p>
...
-   Assume all rewards fit inside $\left[ -\bar{r}, \bar{r} \right]$

Return is Upper Bounded across all possible trajectories $$\lvert G_t \rvert \leq \frac{\bar{r}}{1 - \gamma}$$
...
Define the **state-action value** to be $$Q^\pi (s,a) = \mathbb{E}_{\pi}\left[ \sum_{t=0}^{\infty} \gamma^{t}r(s_t,a_t) \middle| s_0 = s, a_0 = a \right]$$
...
- $\pi^\star$ solves the following: $$V^\star (s) = \max_{\pi} V^\pi (s) \qquad Q^\star (s,a) = \max_{\pi} Q^\pi (s,a)$$
:::
...
Therefore, $$\pi^\star (s) = \text{arg}\max_{a} Q^\star (s,a)$$
...
![*Close your eyes and exclaim "Bellman!"*](figs/fixedpoint.png){height=350 fig-align="center"}

##  Fixed-point iteration in value space {.center}


-   Let's just take the operator $$B(Q^\pi) = r(s,a) + \gamma  \mathbb{E}_{s' \sim p(s' | s, a)}\left[ \max_{a'} Q^\pi (s',a') \right]$$ and apply fixed-point iteration!
...
![[Open RL Benchmark](https://wandb.ai/openrlbenchmark/openrlbenchmark/reports/Atari-CleanRL-s-DQN--VmlldzoxNjk3NjYx) [@huang2024OpenRL]](videos/atari_breakout.gif){fig-align="center"}
...
![](videos/cart_pole.gif){height="90%"}
...
For a **finite** set of actions $\{ a_1, a_2, \ldots, a_d \}$, use a neural network to define
$$\text{DQN}(s) =
\begin{bmatrix}
q_1 \\
\vdots \\
...
\begin{align}
&\bbox[#FF9999,2pt]{\approx} \arg\max_{a} Q^\pi (s,a_i)
\end{align}
...
::: {layout="[[1,1], [1,1]]"}
![Initial](videos/dqn/acrobot-dqn__0__episode-0.gif){width=200}

![After some time...](videos/dqn/acrobot-dqn__0__episode-796.gif){width=200}

![Almost there...](videos/dqn/acrobot-dqn__0__episode-1592.gif){width=200}

![Final](videos/dqn/acrobot-dqn__0__episode-1990.gif){width=200}
:::
::: aside
...
$$\text{maximize}_{\theta} \quad \mathbb{E} \left[ Q_\phi(s, \pi_\theta (s)) \right]$$

##  {.center}

Then $$\max_{a} Q^\pi (s,a) \approx Q_\phi (s, \pi_{\theta} (s))$$
...
![](videos/dp.gif){height=300 fig-align="center"}
:::
...
:::: {.columns}
::: {.column width="50%"}
![](videos/bloopers/5hz-smallTorque_gamma95_acrobat-sac__linf__0__episode-1950.gif)
:::
...
:::: {.columns}
::: {.column width="50%"}
![](videos/bloopers/5hz-smallTorque_gamma99_acrobat-sac__height__0__episode-1950.gif)
:::
...
\begin{align}
\text{minimize } \quad & \sum_{t=0}^{\infty} \gamma^t \left( x_t^2 + \rho u_t^2 \right)\\
...
\begin{align}
\text{minimize } \quad & \sum_{t=0}^{\infty} \gamma^t \left( x_t^2 + u_t^2 \right)\\
\text{where } \quad & x_{t+1} = 1.1 x_t + 0.5 u_t \\
& u_t = -k x_t \\
& x_0 = 1.0
\end{align}
...
![Desmos [[link]](https://www.desmos.com/calculator/j1nsogiwhc)](figs/desmos-graph.png){height=400 fig-align="center"}
...
::: {layout="[[1,1]]"}
!["Input"](videos/anim_impulse_u.gif)

!["Output"](videos/anim_impulse_y.gif)
:::
...
::: {layout="[[1,1]]"}
![](videos/anim_PI_u.gif)

![](videos/anim_PI_y.gif)
:::
...
:::: {.columns}
::: {.column width="40%"}
![](videos/PID_Compensation_Animated.gif)
:::
...
![](figs/Dunning-Kruger.png){fig-align="center"}
...
![](figs/lane_change.png){height=400 fig-align="center"}
...
![](videos/anim_dip_no-obstacle.gif){fig-align="center"}
...
![](videos/anim_dip.gif){fig-align="center"}
...
::: {layout="[[1,1]]" layout-valign="center"}
![](figs/mpc_closedlooptraj1.png){width=350}

![](figs/mpc_closedlooptraj2.png){width=350}
:::
...
![](figs/lqr_constrainedSS.png){height=300}

![](figs/mpc_constrainedSS.png){height=300}
:::
...
![](videos/cl.gif){height=400 fig-align="center"}
...
::: {.r-stack}
\begin{align}
\min_{u_0} \quad & \ell(x_0, u_0) + V_{\theta}(x_1)\\
\text{where } \quad & x_0 = s_t \\
& x_{1} = f(x_0, u_0) \\
& x_1 \in \mathcal{X},\quad u_0 \in \mathcal{U} \\
\end{align}
:::
...
![](figs/Chaotic+Grad+Student+HiRes.png){fig-align="center"}
...
![](videos/anim_disc_3d_uncontrolled.gif)

$$\rightarrow$$

![](videos/anim_disc_3d_ctrl_motor.gif)
:::
...
``` {.python code-line-numbers="1-3,12,13"}
Theta_1 = model.set_variable('parameter', 'Theta_1') 
Theta_2 = model.set_variable('parameter', 'Theta_2')
Theta_3 = model.set_variable('parameter', 'Theta_3')

c, d = np.array([2.697,  2.66,  3.05, 2.86])*1e-3, np.array([6.78,  8.01,  8.82])*1e-5
dphi_next = vertcat(
...
```
![](videos/anim_disc.gif){fig-align="center"}
...
<div> <small>(...A really long list [here](https://github.com/wwxFromTju/awesome-reinforcement-learning-lib))</small> </div>
...
``` {.python code-line-numbers="1,7,8,12,13,18"}
...
![](figs/reward-badmodel-n10.png){height=350 fig-align="center"}
...
![](figs/reward-goodmodel-n10.png){height=350 fig-align="center"}
...
![](figs/baseline-n10.png){fig-align="center"}
...
![](figs/baseline-n1.png){fig-align="center"}
...
<ul style="list-style-type: '+ ';">
  <li>Augmented MPC improves over time</li>
  <li>Somewhat overcomes deficiencies of a "bad" model or short prediction horizon</li>
</ul>
...
<ul style="list-style-type: '- ';">
  <li>Learning is slow/delayed</li>
  <li>Significant variation</li>
</ul>
...
<ul style="list-style-type: '+ ';">
  ...
  <li>Many ways of completing the task</li>
</ul>
:::
...
<ul style="list-style-type: '- ';">
  <li>Degenerate datasets</li>
  <li>Wasted exploration</li>
</ul>
:::
::::
...
::: {.column}
![](figs/virtual-goal.png)
:::
::::


::: aside
See @andrychowicz2017HindsightExperience and [blog post](https://openai.com/index/ingredients-for-robotics-research/)
:::
...
![](videos/masses-noHER-badmodel.gif)

![](videos/masses-noHER-goodmodel.gif)
...
![](videos/masses-HER-badmodel.gif)

![](videos/masses-HER-goodmodel.gif)
...
![Classic, rigorous](figs/neurobertsekas.png){height=375}

![Contemporary, intuitive](figs/alphazerobertsekas.png){height=375}
:::
...
(See also @bhardwaj2020BlendingMPC)
:::
...
## MPC control law is nonlinear {#mpcisnonlinear .center}
...
- State estimation [@nejatbakhshesfahani2023LearningbasedState]
- Differentiable MPC [@gros2020DataDrivenEconomic; @amos2019DifferentiableMPC]
- Offset-free tracking [@maeder2009LinearOffsetfree]
- Industrial control: theory vs practice [@forbes2015ModelPredictive; @elnawawi2022InteractiveVisualization]
