...
::: {style="margin-top: 200px;"}
$$J(\pi) = \mathbb{E}_{s_0 \sim p(s_0)}\left[ V(s_0) \right]$$
:::
...
![Link: [https://github.com/NPLawrence/upperbound-tutorial](https://github.com/NPLawrence/upperbound-tutorial)](figs/qr-github.png){height=400 fig-align="center"}
