...
## The space of policies is vast {visibility="hidden"}
...
::: r-stack
![](videos/gritty.gif){.fragment height=190 fig-align="center"}

![](figs/Honey_UDC.png){.fragment height=210 fig-align="center"}
...
Define the **state-action value** [^1] to be $$Q^\pi (s,a) = \mathbb{E}_{\pi}\left[ \sum_{t=0}^{\infty} \gamma^{t}r(s_t,a_t) \middle| s_0 = s, a_0 = a \right]$$
...
::: {.fragment .fade-in}
![](videos/edmonton-oilers-hunter.gif){.absolute top=200 right=100}
:::
...
::: {.r-stretch}
![](figs/desmos-graph.png){fig-align="center"}
:::
...
![](videos/cl.gif){fig-align="center"}
...
![](figs/Automation+Paradox.png){fig-align="center"}
