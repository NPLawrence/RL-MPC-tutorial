...
class DiscreteAcrobotEnv(Env):
    ...
    # AVAIL_TORQUE = [-1.0, 0.0, +1] # not enough
    AVAIL_TORQUE = [-2.0, 0.0, +2]
    ...
    def step(self, a):
        ...
        self.state = ns
        terminated = self._terminal() # we still return false because we want it to stand
