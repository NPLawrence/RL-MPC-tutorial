...
class ContinuousAcrobotEnv(Env):
    """
    ## Description
    ...
    LINK_MOI = 1.0  #: moments of inertia for both links --- doesnt make sense???
    # LINK_MOI = (LINK_MASS_1/3.0)*LINK_COM_POS_1**2
    # LINK_MOI_1 = (LINK_MASS_1/3.0)*LINK_COM_POS_1**2
    # LINK_MOI_2 = (LINK_MASS_2/3.0)*LINK_COM_POS_2**2
    ...
    def __init__(self, render_mode: Optional[str] = None, reward_fn = "default"):
    ...
    def step(self, a):
        ...
        # reward #1 -- binary based on height
...
if __name__ == '__main__':
    gym.register(
        ...
        entry_point="acrobot:ContinuousAcrobotEnv",
        max_episode_steps=500    )
    env = gym.make("ContinuousAcrobotEnv", render_mode="rgb_array")
    env = gym.wrappers.RecordVideo(env, f"videos/testing/",
